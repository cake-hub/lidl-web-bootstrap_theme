        ...
        <div className="header-preheader container-responsive">
            ...
            <div className="header-wrapper">
                <a href="#" className="header-logo-wrapper">
                    <img src={config.assetPath + "images/logo.svg"} alt="Lidl Logo" className="header-logo" />
                </a>
            ...
            <nav className="header-navigation" data-controller="header/navigation" aria-label="Main">
                ...
                >
                    <Icon name="arrow-left" title="Back" className="icon-2 icon-vertical-middle header-navigation-back-icon" />
                    Back-Function
                </a>
                <button className="btn btn-slider btn-header-navigation-slider btn-header-navigation-slider-previous" data-controller="header/navigation/menu/main/slider/prev">
                    <Icon name="arrow-left" title="Previous Slide" className="icon-2" />
                </button>
                <button className="btn btn-slider btn-header-navigation-slider btn-header-navigation-slider-next" data-controller="header/navigation/menu/main/slider/next">
