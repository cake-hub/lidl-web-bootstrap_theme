...
class themeSlider {
    ...
    get sliderStatus () {
        ...
        let positionDiff = ((sliderRect.x || sliderRect.left) + sliderRectWidth) - ((themeSliderRect.x || themeSliderRect.left) + themeSliderRectWidth);
...
window.cake.themeSlider = (options = defaultOptions) => {
    ...
    let sliders = [];
    const themeSliderElements = window.cake.utils.getElements (options.sliderElements, options.sliderQuerySelector);
    for (const [idx, themeSliderElement] of themeSliderElements.entries ()) {
        const themeSliderListElement = window.cake.utils.getElement (options.sliderListElements [idx], options.sliderListQuerySelector, themeSliderElement);
        const themeSliderPreviousButtonElement = window.cake.utils.getElement (options.sliderPreviousButtonElements [idx], options.sliderPreviousButtonuerySelector, themeSliderElement);
        const sliderNextButtonElementElement = window.cake.utils.getElement (options.sliderNextButtonElements [idx], options.sliderNextButtonuerySelector, themeSliderElement);
