...
const Subnavigation = (navigationStructure) => (
    <React.Fragment>
        <button className="btn btn-slider btn-header-subnavigation-slider btn-header-navigation-slider-previous" data-controller="header/navigation/menu/sub/slider/prev">
            <Icon name="arrow-left" title="Previous Slide" className="icon-2" />
        </button>
        <button className="btn btn-slider btn-header-subnavigation-slider btn-header-navigation-slider-next" data-controller="header/navigation/menu/sub/slider/next">
